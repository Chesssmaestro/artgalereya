...
export const translations: Record<Language, TranslationData> = {
  uz: {
    ...
    works: {
      ...
      marionettes1: { imgKey: "marionettes1", title: "QO'G'IRCHOQLAR-1", meta: "2025 · 10 daqiqa" },
      marionettes2: { imgKey: "marionettes2", title: "QO'G'IRCHOQLAR-2", meta: "2025 · 12 daqiqa" },
      balance: { imgKey: "balance", title: "MUVOZANAT", meta: "2025 · 10 daqiqa" },
      pendulum: { imgKey: "pendulum", title: "MAYATNIK-5", meta: "2023 · 10 daqiqa" },
  ...
  en: {
    ...
    works: {
      ...
      marionettes1: { imgKey: "marionettes1", title: "MARIONETTES-1", meta: "2025 · 10 min" },
      marionettes2: { imgKey: "marionettes2", title: "MARIONETTES-2", meta: "2025 · 12 min" },
      balance: { imgKey: "balance", title: "BALANCE", meta: "2025 · 10 min" },
      pendulum: { imgKey: "pendulum", title: "PENDULUM-5", meta: "2023 · 10 min" },
  ...
  ru: {
    ...
    works: {
      ...
      marionettes1: { imgKey: "marionettes1", title: "МАРИОНЕТКИ-1", meta: "2025 · 10 мин" },
      marionettes2: { imgKey: "marionettes2", title: "МАРИОНЕТКИ-2", meta: "2025 · 12 мин" },
      balance: { imgKey: "balance", title: "БАЛАНС", meta: "2025 · 10 мин" },
      pendulum: { imgKey: "pendulum", title: "МАЯТНИК-5", meta: "2023 · 10 мин" },
